    ...
    <div className="min-h-screen flex items-center justify-center bg-black py-8 px-4 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          >
            Join Muscle Strength and start your fitness journey
          </motion.p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <motion.div variants={itemVariants} className="mb-5">
              ...
              {password && password.length < 6 && (
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="text-orange-400 text-xs mt-2 pl-1"
                >
            ...
            <motion.div variants={itemVariants} className="mb-7">
              ...
              <input
                ...
                required
                autoComplete="new-password"
                className={`w-full py-3.5 px-4 rounded-xl border bg-black/50 text-white text-sm outline-none focus:ring-2 transition-all duration-300 placeholder:text-gray-600 ${
              ...
              {confirmPassword && confirmPassword === password && (
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="text-green-400 text-xs mt-2 pl-1 flex items-center gap-1"
                >
          ...
          <motion.p
            variants={itemVariants}
            className="text-center mt-5 text-gray-500 text-xs leading-relaxed"
          >
            By creating an account, you agree to our{' '}
            <Link to="/terms" className="text-blue-400 hover:text-blue-300 transition-colors no-underline">
              Terms of Service
            </Link>{' '}
            and{' '}
            <Link to="/privacy" className="text-blue-400 hover:text-blue-300 transition-colors no-underline">
              Privacy Policy
            </Link>
          </motion.p>
        </motion.div>
        ...
        >
          ...
          <Link to="/login" className="text-blue-400 hover:text-blue-300 font-semibold transition-colors no-underline">
            Sign In
          </Link>
        </motion.p>
      </motion.div>
